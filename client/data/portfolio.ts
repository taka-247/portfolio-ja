  ...
  works: {
    ...
    'IgniteMe': {
      detail: {
        ...
        DETAILDS: [
          'Dart、そのフレームワークであるFlutterへの理解を深めるため開発した個人プロジェクトで、ユーザーの日々の生産性向上を目的としたモバイルアプリケーション。ユーザーは1日の生産性向上のために予めアプリ内で用意されたコンポーネント（コミットメンt）をカスタマイズして、達成と未達成を登録することができる。TODOアプリやスケジュール管理アプリではなく、あくまでルーティーン形成と継続による日々の生産性向上に特化したアプリです。',
        ],
        PERIOD: '2026年2月 -',
        LINK: '非公開',
      },
